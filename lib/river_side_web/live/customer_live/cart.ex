              ...
              <div class="card-body">
                <div class="flex items-center justify-between mb-2">
                  <div class="flex items-center gap-3">
                    <%= if vendor_items.vendor.logo_url do %>
                      <img
                        src={vendor_items.vendor.logo_url}
                        alt={vendor_items.vendor.name}
                    ...
                    <div>
                      ...
                      <%= if vendor_items.vendor.description do %>
                        <p class="text-xs text-base-content/70">{vendor_items.vendor.description}</p>
                      <% end %>
                    </div>
                  </div>
