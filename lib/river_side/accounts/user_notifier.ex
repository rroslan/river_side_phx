defmodule RiverSide.Accounts.UserNotifier do
  ...
  def deliver_update_email_instructions(user, url) do
    ...
    deliver(user.email, "Update your email - River Side Food Court", text_body, html_body)
  end
  ...
  defp deliver_magic_link_instructions(user, url) do
    ...
    deliver(user.email, "Your login link - River Side Food Court", text_body, html_body)
  end
